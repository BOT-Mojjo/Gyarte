...
public class subject{
    ...
    public List<(int, int, int, int)> Color { get; set; } //in sets of 2, [0] = first foreground color, [1] = first background color, [n] = foreground color, [n+1] background color for that round.
}
